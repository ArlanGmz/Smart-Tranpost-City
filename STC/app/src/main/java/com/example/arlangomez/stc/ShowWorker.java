...
public class ShowWorker extends AsyncTask<String, Void, String>{
    ...
    public ShowWorker.AsyncResponse delegate = null;
    public ShowWorker(ShowWorker.AsyncResponse delegate){
